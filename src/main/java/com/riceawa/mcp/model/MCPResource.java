...
public class MCPResource {
    ...
    /**
     * 从JSON字符串创建MCPResource对象
     */
    public static MCPResource fromJson(String json) throws MCPException {
        return MCPJsonUtils.fromJsonToResource(json);
    }

    /**
     * 创建当前对象的深度拷贝
     */
    public MCPResource deepCopy() throws MCPException {
